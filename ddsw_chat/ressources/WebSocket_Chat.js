		...
		//Starten der WebSocket-Verbindung, Ändern der Serveradresse
                try{
        ...
        //Sendefunktion (Tags werden entfernt, Eingabe in JSON-Message gewandelt und Eingabe gelöscht)
                function senden(){
                    var jsObj = {
                        "event": "send",
                        "message": $("#eingabe").val(),
            ...
            //Senden nach Drücken des Buttons               
                $("#button1").click(function(){
                     senden();
                 });
                        
             //Senden nach Drücken der Enter-Taste
              ...
              //Abschalten der Vervollständigung für das Eingabefeld
